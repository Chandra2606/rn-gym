  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setNamaLengkap(json.namamember);
  ...
  const submitForm = async () => {
    ...
    fetch(`${apiUrl}member/${kdmember}`, {
      ...
      .then(async response => {
        ...
        Alert.alert('Success', 'Data member berhasil DiUpdate', [
          {
            text: 'ok',
            onPress: () =>
              navigation.navigate('DetailMember', {kdmember: kdmember}),
          },
        ]);
      })
      .catch(error => {
