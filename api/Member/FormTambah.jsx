...
const FormTambah = () => {
  const [kdmember, setKode] = useState('');
  ...
  const submitForm = async () => {
    ...
    fetch(`${apiUrl}member`, {
      ...
      .then(async response => {
        ...
        Alert.alert('Success', 'Data member berhasil ditambahkan', [
          {
            text: 'ok',
            onPress: () => navigation.navigate('DataMember', {dataAdded: true}),
          },
        ]);
      })
      .catch(error => {
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        errorMessage={validationErrors.kdmember}
      />
      ...
      <Input
        ...
        errorMessage={validationErrors.namamember}
      />
