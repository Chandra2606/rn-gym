...
const ActionButton = ({kodeteknisi}) => {
  ...
  const actionDeleteData = async () => {
    ...
    Alert.alert(
      'konfirmasi',
      'Apakah anda yakin ingin menghapus data teknisi ini?',
      [
        {
          text: 'Batal',
        ...
        },
        {
          ...
          onPress: () => {
            ...
            fetch(`${apiUrl}teknisi/${kodeteknisi}`, {
              method: 'DELETE',
              headers: {
              ...
              .then(response => {
                if (response.status === 200) {
                  Alert.alert('', 'Data teknisi berhasil dihapus!', [
                    {
                      text: ' ok',
                      onPress: () =>
                        navigation.navigate('DataTeknisi', {
                          dataAdded: true,
                        }),
                    },
                  ]);
  ...
  const showFormEdit = () => {
    navigation.navigate('FormEdit', {kodeteknisi: kodeteknisi});
  };
  return (
    <View
      style={{
